...
/// </summary>
[AddComponentMenu("BoneCracker Games/Realistic Car Controller Pro/UI/RCCP Canvas Customization")]
public class RCCP_UI_Canvas_Customization : MonoBehaviour {
    ...
    private void Update() {
        ...
        RCCP_CustomizationApplier currentApplier = RCCP_CustomizationManager.Instance.vehicle;
    ...
    public void ToggleAutoRotation(bool state) {
        ...
        RCCP_ShowroomCamera showroomCamera = FindObjectOfType<RCCP_ShowroomCamera>();
    ...
    public void DisableCustomization() {
        ...
        if (RCCP_CustomizationDemo.Instance)
            RCCP_CustomizationDemo.Instance.DisableCustomization();
